...
// Add dependency to Dataflow Runner in build.gradle
// compile project(":runners:google-cloud-dataflow-java")
//
// Add an execute gradle task in build.gradle
...
public class TestPipeline {
  ...
  public static void main(String[] args) {
    ...
    String header1[]= Splitter.on(',').splitToList(header).toArray(new String[0]);
    ...
    PCollection<Row> QueryOutput =
        JoinQuery.apply("Execute Query", SqlTransform.query(query));
