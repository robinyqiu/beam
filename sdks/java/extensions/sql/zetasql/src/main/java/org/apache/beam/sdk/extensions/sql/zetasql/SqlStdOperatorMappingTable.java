...
public class SqlStdOperatorMappingTable {
  ...
  // TODO[BEAM-8630]: moving more functions in ZETASQL_FUNCTION_TO_CALCITE_SQL_OPERATOR to this map
  public static final Map<String, TypeKind> ZETASQL_FUNCTION_NAME_TO_RETURN_TYPE =
      ImmutableMap.<String, TypeKind>builder()
          .put("current_timestamp", TypeKind.TYPE_TIMESTAMP)
          .put("string", TypeKind.TYPE_STRING)
          .put("timestamp_add", TypeKind.TYPE_TIMESTAMP)
          .put("timestamp_sub", TypeKind.TYPE_TIMESTAMP)
          .put("timestamp_diff", TypeKind.TYPE_INT64)
          .put("timestamp_trunc", TypeKind.TYPE_TIMESTAMP)
          .put("format_timestamp", TypeKind.TYPE_STRING)
          .put("parse_timestamp", TypeKind.TYPE_TIMESTAMP)
          .put("timestamp_seconds", TypeKind.TYPE_TIMESTAMP)
          .put("timestamp_millis", TypeKind.TYPE_TIMESTAMP)
          .put("unix_seconds", TypeKind.TYPE_INT64)
          .put("unix_millis", TypeKind.TYPE_INT64)
          .put("timestamp_from_unix_seconds", TypeKind.TYPE_TIMESTAMP)
          .put("timestamp_from_unix_millis", TypeKind.TYPE_TIMESTAMP)
          .build();
